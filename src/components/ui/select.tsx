  ...
  const filteredChildren = React.useMemo(() => {
    ...
    return React.Children.toArray(children).filter((child) => {
      ...
      if (child.type === SelectGroup) {
        const filteredGroupChildren = React.Children.toArray(child.props.children).filter(
          (groupChild) => {
          ...
          <div className="sticky top-0 z-10 bg-popover px-2 py-1.5 border-b">
            <div className="relative">
              ...
              <input
                ...
                className="flex h-8 w-full rounded-md bg-transparent pl-8 pr-2 text-sm outline-none placeholder:text-muted-foreground"
                value={searchTerm}
